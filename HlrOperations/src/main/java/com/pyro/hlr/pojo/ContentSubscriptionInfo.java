 ...
 * 
 */
public class ContentSubscriptionInfo {

	
	//akshay 30-06-2017 as confirmed by karunesh sir
	//private int scp_id;
	...
	private int balance_check_type;
...
/*	public int getScp_id() {
	...
	public String getMixed_unique() {
		return mixed_unique;
	}

	public void setMixed_unique(String mixed_unique) {
		this.mixed_unique = mixed_unique;
	}
	...
	public int getBalance_check_type() {
		return balance_check_type;
	}

	public void setBalance_check_type(int balance_check_type) {
		this.balance_check_type = balance_check_type;
	}

	
	public ContentSubscriptionInfo getCloneObject() {
		
		ContentSubscriptionInfo sInfo = new ContentSubscriptionInfo();
		...
		sInfo.service_status = this.service_status;
	...
	public String toString() {
		...
		text = text + "&sub_content_id="+sub_content_id;
		text = text + "&content_name="+content_name;
		text = text + "&mixed_unique="+mixed_unique;
